 ...
 */
final class Version20230202235717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE freelance (id INT AUTO_INCREMENT NOT NULL, cv_id INT DEFAULT NULL, profile_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, surname VARCHAR(50) NOT NULL, siretnumber INT DEFAULT NULL, birthday VARCHAR(50) DEFAULT NULL, freelancetypes LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_48ABC675CFE419E2 (cv_id), INDEX IDX_48ABC675CCFA12B8 (profile_id), INDEX IDX_48ABC675A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE freelance ADD CONSTRAINT FK_48ABC675CFE419E2 FOREIGN KEY (cv_id) REFERENCES media_object (id)');
        $this->addSql('ALTER TABLE freelance ADD CONSTRAINT FK_48ABC675CCFA12B8 FOREIGN KEY (profile_id) REFERENCES media_object (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE freelance DROP FOREIGN KEY FK_48ABC675CFE419E2');
        $this->addSql('ALTER TABLE freelance DROP FOREIGN KEY FK_48ABC675CCFA12B8');

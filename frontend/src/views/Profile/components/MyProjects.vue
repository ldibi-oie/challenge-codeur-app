<template lang="">
    <div>
          <div class="flex flex-col justify-center my-5" >
            ...
            <div class="overflow-x-auto" v-if="projets">
                    ...
                    <div class="overflow-hidden shadow">
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                              ...
                              <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" v-for="item in projets">
                                  
                                  <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                      <div class="text-base font-semibold text-gray-900 dark:text-white">{{item.title}}</div>
                                      <div class="text-sm font-normal text-gray-500 dark:text-gray-400">{{item.company?.name}}</div>
                                  </td>
                                  <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{item.company?.name}}</td>
                                  <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{item.status}}</td>
      
                                  <td class="p-4 space-x-2 whitespace-nowrap" v-if="!item.comments">

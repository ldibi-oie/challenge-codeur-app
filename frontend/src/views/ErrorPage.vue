    ...
    <div>
        <div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900">
            ...
            <div class="text-center xl:max-w-4xl">
                ...
                <p class="mb-5 text-base font-normal text-gray-500 md:text-lg dark:text-gray-400">Oups ! Il semble que vous ayez suivi un mauvais lien. Si vous pensez qu'il s'agit d'un problème pour nous, veuillez nous le signaler.</p>
                <router-link to='/' class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">

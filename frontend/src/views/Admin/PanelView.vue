<template>
    <!-- <div class="w-full min-h-screen">
        <NavbarAdmin/>
        <div class="flex">
            <div class="flex-none w-32 inset-y-0 left-0">
                <div v-if="load" class="m-auto">
                    <svg
                        aria-hidden="true"
                ...
                <div class="bg-gray-50 dark:bg-gray-800">
                    <ul class="space-y-2">
                        <li v-for="item in Object.keys(data).slice(3)" :key="item">
                            <button v-on:click="_handleClick(data[item])">
                                {{ item }}
                            </button>
                        </li>
                    </ul>
            ...
            <div class="flex-auto w-64">
                <TableAdmin ref="tableAdmin" :path="path"/>
                {{ path }}
            </div>
        </div>
    </div> -->
...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <button class="bg-blue-500 py-2 px-4 rounded-md text-white dark:text-black mx-5">
        ...
        <TableAdmin ref="tableAdmin" :path="pathu" />
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async formData() {
                this.$router.push({ name: 'admin_form_add', query: { submitApi: '/api/categories', submitApiMethod: 'post' } });
            },
        },
    }
</script>
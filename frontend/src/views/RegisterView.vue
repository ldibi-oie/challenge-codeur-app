    ...
    >
      ...
      <form class="mt-8 space-y-6" @submit.prevent="submitForm">
        ...
        <div class="flex items-start">
          <div class="flex items-center h-5">
            <input
              ...
              name="remember"
              type="checkbox"
              class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-red-300 dark:focus:ring-red-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600"
              required=""
            />
          </div>
        ...
        >
          ...
          <span v-if="isLoading === false"> Create your account </span>
        </button>

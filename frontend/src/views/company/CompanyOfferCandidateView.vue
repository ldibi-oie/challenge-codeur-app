          ...
          <div class="flex flex-col  p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <div v-for="item in offers" class="grid w-full md:grid-cols-2">
                <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <span v-for="keyword in item.keywords" class="bg-green-100 text-green-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-900"> {{ keyword.name }}</span>
                        ...
                        <div class="mb-1 font-normal text-gray-700 dark:text-gray-400"> 
                            <span class="text-2xs font-bold tracking-tight text-gray-900 dark:text-white"> Status : 
                                <span  class="bg-green-100 text-green-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-900" v-show="item.status == 'open'"> Ouvert </span> 
                                <span  class="bg-red-100 text-red-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900" v-show="item.status == 'closed'"> Fermé </span> 
                        </span></div>
                        <div class="mb-1 font-normal text-gray-700 dark:text-gray-400"> 

...
<div v-else class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div class="mb-4">
            <div
                class="flex items-center justify-center h-8 rounded bg-white dark:bg-gray-800">
        ...
        <div class="p-6 min-h-fit mb-4 rounded bg-green-100 dark:bg-gray-800" v-if="offer.selectedCandidate.length != 0">
        ...
        <div class="flex items-center justify-start h-48 mb-4 rounded bg-gray-50 p-4" v-else>
            <div>
        ...
        <div class="flex flex-col items-start justify-center h-48 mb-4 rounded bg-gray-50 p-4" v-if="offer.comments.length != 0">

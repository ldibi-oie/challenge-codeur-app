<template>
    <div>
        <nav class="fixed z-30 w-full bg-white border-b justify-center border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">MyProject Codeur</span>
                ...
                <div class="flex items-center" v-if="isLogged === true">
                  <router-link to="/profile" class="rounded-md bg-red-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Mon compte</router-link>
                </div>  

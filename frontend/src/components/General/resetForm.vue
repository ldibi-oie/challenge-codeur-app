<template>
    <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
        ...
        <div :class="{'w-full max-w-xl p-6 flex flex-col items-center space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800' : section === true , 'hidden' : section === false}">
...
<script>
import { sendResetPassword } from '../../stores/usersFunction'
export default {
    data(){
        return {
            email: '',
    ...
    methods: {
        submitResetPassword: async function(){
            ...
            this.isLoading = true
            await sendResetPassword(this.email).then((st) => {

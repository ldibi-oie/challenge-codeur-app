            ...
            <ul>
                <li>
                    <RouterLink to="/company">
                        ...
                        <Transition name="fade">
                            <span v-show="isSidebarOpen">Profil</span>
                        </Transition>
                    </RouterLink>
                </li>
                ...
                <li>
                    <RouterLink to="/offer">
                        <IconDocumentation />
                        <Transition name="fade">
                            <span v-show="isSidebarOpen">Offre</span>
                        </Transition>
                    </RouterLink>
                </li>
                ...
                <li>
                    <RouterLink to="/offer">
                        <IconSupport />
                        <Transition name="fade">
                            <span v-show="isSidebarOpen">Postulants</span>
                        </Transition>
                    </RouterLink>
                </li>
                ...
                <li>
                    <RouterLink to="/offer">
                        <IconCommunity />
                        <Transition name="fade">
                            <span v-show="isSidebarOpen">Messages</span>
                        </Transition>
                    </RouterLink>
                </li>
            </ul>
